...
bool SDCP_Common::sessionId2Bytes(const QString &id , unsigned char *bytes, int index)
{
...
bool SDCP_Common::bytes2sessionId(const unsigned char *bytes, int startIndex, QString &id)
{
    id.resize(SessionID_ByteSize*2);
    id.fill(0, SessionID_ByteSize*2);
